                ...
                @foreach($data as $items)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            @if($items->package_complete_status == 0)
                                @can('approve-complete-package')
                                <a style="cursor: pointer" data-href="{{url('approveCompletePackage')}}" data-id="{{$items->id}}" class="btn bg-info btn-sm approveCompletePackage" data-popup="tooltip" title="Approve Package Complete" data-placement="top"><i class="fa fa-check"></i></a>
                                @endcan
                            @endif
                        </td>
                    </tr>
