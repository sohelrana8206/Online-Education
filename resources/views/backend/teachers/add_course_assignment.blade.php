<form action="{{url('storeCourseAssignment')}}" method="post">
    @csrf
    <div class="modal-header bg-brown">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h6 class="modal-title">Course Assignment Add Form</h6>
    </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn bg-brown">Add Course Assignment</button>
    </div>
</form>
