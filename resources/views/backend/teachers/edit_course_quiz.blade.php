<form action="{{url('updateCourseQuiz/'.$data->id)}}" method="post">
    @csrf
    @method('PUT')
    <div class="modal-header bg-success">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h6 class="modal-title">Course Quiz Edit Form</h6>
    </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn bg-success">Update Course Quiz</button>
    </div>
</form>
