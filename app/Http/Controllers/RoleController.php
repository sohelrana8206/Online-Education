...
class RoleController extends Controller
{
    ...
    {
        $this->middleware('permission:role-list|role-create|role-edit|role-details|role-delete', ['only' => ['index','store']]);
        $this->middleware('permission:role-create', ['only' => ['create','store']]);
        $this->middleware('permission:role-edit', ['only' => ['edit','update']]);
        $this->middleware('permission:role-details', ['only' => ['show']]);
        $this->middleware('permission:role-delete', ['only' => ['delete_role']]);
    }
