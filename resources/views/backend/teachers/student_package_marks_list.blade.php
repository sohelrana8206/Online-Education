...
<div class="modal-footer">
    ...
    @can('add-student-package-mark')
    <a style="cursor: pointer" data-href="{{url('addStudentPackageMarks')}}" data-id="{{$packageID->course_package_id}}" data-stdID="{{$stdID}}" class="btn bg-primary addStudentPackageMarks">Add Marks</a>
    @endcan
</div>