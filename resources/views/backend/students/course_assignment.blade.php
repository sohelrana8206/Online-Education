                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            @if($isSubmitAssignment == 0)
                                <a style="cursor: pointer" data-href="{{url('startCourseAssignment')}}" data-id="{{$items->id}}" class="btn btn-info btn-sm startCourseAssignment" data-popup="tooltip" title="Submit Assignment" data-placement="top">Submit Assignment</a>
                            @else
