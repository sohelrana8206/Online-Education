...
<div class="content-wrapper">
    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Course Review Form</span></h4>
            </div>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="content">
        ...
        <!-- Basic datatable -->
        <form style="margin-bottom: 50px" action="{{url('storeCourseReview')}}" method="post">
            @csrf
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Course Review Form</h5>
                </div>
