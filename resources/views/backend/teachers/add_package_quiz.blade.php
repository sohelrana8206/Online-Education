<form action="{{url('storePackageQuiz')}}" method="post">
    @csrf
    <div class="modal-header bg-success">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h6 class="modal-title">Package Quiz Add Form</h6>
    </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn bg-success">Add Package Quiz</button>
    </div>
</form>
