...
<div class="content-wrapper">
    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Free Quiz</span> Create form</h4>
            </div>
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li class="active">Free Quiz Create form</li>
            </ul>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="content">
        ...
        <!-- Registration form -->
        <form style="margin-bottom: 50px" action="{{url('storeFreeQuiz')}}" method="post">
            @csrf
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Free Quiz Create Form</h5>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="text-right mt-5">
                        <button type="submit" class="btn btn-primary">Create Free Quiz <i class="icon-arrow-right14 position-right"></i></button>
                    </div>
                </div>
            </div>
        </form>
