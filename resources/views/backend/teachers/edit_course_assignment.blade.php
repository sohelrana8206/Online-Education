<form action="{{url('updateCourseAssignment/'.$data->id)}}" method="post">
    @csrf
    @method('PUT')
    <div class="modal-header bg-brown">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h6 class="modal-title">Course Assignment Edit Form</h6>
    </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn bg-brown">Update Course Assignment</button>
    </div>
</form>
