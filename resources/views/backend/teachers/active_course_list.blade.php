    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Active Course</span> List</h4>
            </div>
        </div>
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li class="active">Active Course List</li>
            </ul>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">Active Course List</h5>
            </div>
                ...
                @foreach($data as $items)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            @can('inactivate-course')
                            <a style="cursor: pointer" data-href="{{url('inactivateCourse')}}" data-id="{{$items->id}}" class="btn btn-danger btn-sm inactivateCourse" data-popup="tooltip" title="Course Inactivate" data-placement="top"><i class="fa fa-close"></i></a>
                            @endcan
