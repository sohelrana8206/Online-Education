<form action="{{url('updatePackageQuiz/'.$data->id)}}" method="post">
    @csrf
    @method('PUT')
    <div class="modal-header bg-success">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h6 class="modal-title">Package Quiz Edit Form</h6>
    </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn bg-success">Update Package Quiz</button>
    </div>
</form>
