    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Active Teachers</span> List</h4>
            </div>
        </div>
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li class="active">Active Teachers List</li>
            </ul>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">Active Teachers List</h5>
            </div>
                ...
                @foreach($data as $items)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            @endcan
                            @can('teachers-commission')
                            <a style="cursor: pointer" data-href="{{url('courseCommission')}}" data-id="{{$items->id}}" class="btn btn-primary btn-sm courseCommission" data-popup="tooltip" title="Teachers Course Commission" data-placement="top"><i class="fa fa-dollar"></i></a>
                            @endcan
                            @can('suspend-user')
                            <a class="btn btn-warning btn-sm suspendUsers" data-href="{{url('suspendUsers')}}" data-id="{{$items->id}}" data-popup="tooltip" title="Suspend Teacher" data-placement="top"><i class="fa fa-remove"></i></a>
                            @endcan
                            @can('user-delete')
