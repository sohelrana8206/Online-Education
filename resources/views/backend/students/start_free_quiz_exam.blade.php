...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="timer">
            <h1>Remaining Time: <span id="time">{{$data->last()->free_quiz_setting->time_duration}}:00</span> minutes</h1>
        </div>
        ...
        @foreach($data as $item)
                <div class="course-quiz">
                    ...
                    <div class="quiz-answer hide">
                        <strong>Answer: </strong><?=$item->answer?>
                    </div>
                </div>
        <?php $counter++; ?>
        @endforeach
            <button type="button" class="btn btn-success waves-effect show-answer">Finished</button>
    </div>
    <!-- /content area -->
...
<!-- /main content -->
    ...
    <script>
        var timer2 = {{$data->last()->free_quiz_setting->time_duration}}+":01";
        var isPaused = false;
        var interval = window.setInterval(function() {
            if(!isPaused) {
                ...
                if(minutes == 0 && seconds == 0){
                    ...
                    $('.quiz-answer').removeClass('hide');
                    $('.show-answer').addClass('hide');
                }
            }
        }, 1000);

        /*REMOVE CSS CLASS IN FREE QUIZ START PAGE*/
