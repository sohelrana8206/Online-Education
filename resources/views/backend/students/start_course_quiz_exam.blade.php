...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <form id="submitQuizAnswer" action="{{url('submitQuizAnswer')}}" method="post">
                @csrf
                <div class="timer">
                    <h1>Remaining Time: <span id="time">{{$data->last()->course_quiz_setting->time_duration}}:00</span> minutes</h1>
                </div>
                ...
                @foreach($data as $item)
                    <div class="course-quiz">
                        ...
                        <div class="quiz-options">
                            ...
                            <input type="hidden" name="course_quiz_setting_id[]" value="{{$item->course_quiz_setting_id}}">
                        </div>
                    </div>
                    <?php $counter++; ?>
                @endforeach
    ...
    <script>
        var timer2 = {{$data->last()->course_quiz_setting->time_duration}} + ":01";
        var isPaused = false;
