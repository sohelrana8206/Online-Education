    ...
    <div class="page-header page-header-default">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Course Package</span> List</h4>
            </div>

            <div class="heading-elements">
                <div class="heading-btn-group">
                    @can('course-package-create')
                    <a href="{{url('addCoursePackage')}}" class="btn btn-info"><i class="fa fa-plus"></i> Add New Course Package</a>
                    @endcan
                </div>
            </div>
        </div>
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li class="active">Course Package List</li>
            </ul>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">Course Package List</h5>
            </div>
            ...
            <table class="table datatable-basic">
                ...
                @foreach($data as $items)
                    <tr>
                        ...
                        <td>
                            @if($items->is_package_verified == 0)
                                <label class="badge badge-success">Pending</label>
                            @elseif($items->is_package_verified == 1)
                        ...
                        <td class="text-center">
                            ...
                            @can('edit-course-package')
                            <a href="{{url('editCoursePackage/'.encrypt($items->id))}}" class="btn btn-info btn-sm" data-popup="tooltip" title="Edit Course Package" data-placement="top"><i class="fa fa-pencil"></i></a>
                            @endcan
                            ...
                            @if($items->is_package_verified == 1)
