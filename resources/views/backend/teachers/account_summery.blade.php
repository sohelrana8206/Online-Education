...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-lg-3">
                ...
                <div class="panel bg-teal-400">
                    <div class="panel-body">
                        <h3 class="no-margin">{{$totalReferralCommission}}/-</h3>
            ...
            <div class="col-lg-3">
                ...
                <div class="panel bg-success-400">
                    <div class="panel-body">
                        <h3 class="no-margin">{{$totalCourseCommission}}/-</h3>
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">My All Course Commissions</h5>
            </div>
            ...
            <table class="table datatable-basic">
                ...
                <tbody>
                <?php $counter = 1; ?>
                @foreach($totalCourseIncome['courseIncome'] as $items)
                    <tr>
                        <td><?=$counter?></td>
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">My All Referral Commissions</h5>
            </div>
